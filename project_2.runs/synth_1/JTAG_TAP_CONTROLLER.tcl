...
synth_design -top JTAG_TAP_CONTROLLER -part xc7k70tfbv676-1
...
write_checkpoint -force -noxdef JTAG_TAP_CONTROLLER.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file JTAG_TAP_CONTROLLER_utilization_synth.rpt -pb JTAG_TAP_CONTROLLER_utilization_synth.pb"  } 
